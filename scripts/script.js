...
function initPeriod() {
    [selectMonth, selectYear].forEach(el => el.addEventListener('change', () => {
...
function renderProjectTable() {
    const projectData = appState.monthlyData[currentPeriod];
